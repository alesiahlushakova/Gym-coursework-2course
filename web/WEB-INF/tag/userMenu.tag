        ...
        <c:if test="${sessionScope.user != null}">
            ...
            <c:choose>
                <c:when test="${sessionScope.user.userRole == 'TRAINER'}">
                    <li>
                        <a href="${pageContext.request.contextPath}/ControllerServlet?command=trainer_prepare_training_program_creation">${pageScope.create_training_program}</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/jsp/trainer/create_exercise.jsp">${pageScope.create_exercise}</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/ControllerServlet?command=trainer_show_personal_clients">${pageScope.show_personal_clients}</a>
                    </li>
                </c:when>
                <c:when test="${sessionScope.user.userRole == 'ADMIN'}">
                    <li>
                        <a href="${pageContext.request.contextPath}/ControllerServlet?command=admin_show_all_clients">${pageScope.show_clients}</a>
                    </li>
                    <li>
